...
class MainGridListItemHelper(val con: Context): ItemTouchHelper.Callback() {
...
//        Log.d(TAG, "Orign position : $dX,$dY")
        if (actionState == ItemTouchHelper.ACTION_STATE_SWIPE) {
            val view = (viewHolder as MainGridListAdapter.MainGridItemViewHolder).binding.layoutItem
...
//            Log.d(TAG, "moved position : $dX,$dY")
    ...
    override fun clearView(
        ...
        getDefaultUIUtil().clearView((viewHolder as MainGridListAdapter.MainGridItemViewHolder).binding.layoutItem)
    }
    ...
    override fun onSwiped(viewHolder: RecyclerView.ViewHolder, direction: Int) {
        val itemViewHolder = viewHolder as MainGridListAdapter.MainGridItemViewHolder
