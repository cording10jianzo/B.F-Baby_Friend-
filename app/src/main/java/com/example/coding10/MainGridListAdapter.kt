...
import com.example.coding10.databinding.ItemMainGridBinding


class MainGridListAdapter : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        return when (viewType) {
            BFMainListViewType.Category -> {
                ...
                MainGridItemViewHolder(
                    ItemMainGridBinding.inflate(LayoutInflater.from(parent.context))
                )
            }
        }
    }
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        ...
        when (holder) {
            is MainCategoryViewHolder -> {
                ...
                (holder as MainGridItemViewHolder).bind(item)
    ...
    class MainGridItemViewHolder(val binding: ItemMainGridBinding) :
